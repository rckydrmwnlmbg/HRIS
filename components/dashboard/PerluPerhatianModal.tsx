      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ 
              width: 32, height: 32, borderRadius: 'var(--radius-sm)', background: 'rgba(245, 158, 11, 0.12)', 
              display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#f59e0b', border: '1px solid rgba(245, 158, 11, 0.25)' 
            }}>
              <Zap size={16} />
            </div>
            <div>
          ...
          {[
            ...
            return (
              <button
                ...
                style={{
                  padding: '4px 10px', borderRadius: '100px', fontSize: 11, fontWeight: 550,
              ...
              >
                ...
                <span style={{ 
                  ...
                  fontSize: 9.5, padding: '0px 5px', borderRadius: '10px'
                }}>
                  {tab.count}
                </span>
              </button>
